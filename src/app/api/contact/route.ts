...
<div style="max-width: 680px; margin: 0 auto; background-color: #292524; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.3); border: 1px solid #44403c;">
  ...
  ">
    ...
    <p style="
      ...
      opacity: 0.9;
    ">
      Um visitante enviou uma nova mensagem através do seu portfólio
    </p>
  </div>

  <!-- Content -->
  <div style="padding: 48px 40px;">
    <p style="font-size: 16px; margin-bottom: 24px; color: #d6d3d1;">
      Olá <span style="color: #f45c2d; font-weight: 600;">Yuri Manhiça</span>,
    </p>
    <p style="margin-bottom: 24px; color: #d6d3d1;">
      Recebeste uma nova mensagem de contacto através do teu website. Abaixo seguem os detalhes:
    </p>

    <!-- Dados do remetente -->
    <div style="background: #44403c; padding: 24px; border-left: 4px solid #f45c2d; border-radius: 8px; margin-bottom: 32px;">
      <div style="display: flex; justify-content: space-between; align-items: center; padding: 8px 0; border-bottom: 1px solid #57534e;">
    ...
    <!-- Ação rápida -->
    <div style="margin-top: 40px; text-align: center; background: #44403c; border-radius: 8px; padding: 16px 20px; font-size: 15px; color: #d6d3d1; border: 1px solid #57534e;">
      <p style="margin: 0;">
        💬 Para responder, clique em 
  ...
  <div style="text-align: center; padding: 40px 32px; background: #1c1917; border-top: 1px solid #44403c;">
    <p style="margin: 8px 0; font-size: 14px; color: #a8a29e;">
      E-mail automático gerado a partir do portfolio de 
      <strong style="color: #f45c2d;">Yuri Manhiça</strong>.
    </p>
    <p style="margin: 8px 0; font-size: 14px; color: #a8a29e;">
      © ${new Date().getFullYear()} Yuri Manhiça. Todos os direitos reservados.
    </p>
  </div>
